      ...
      <div>
        ...
        <div class="reporting-line">
          <div class="row">
            <div class="col-xl-5">
              <div class="title">
                Количество незакрепленных рыбохозяйственных водоемов (с указанием общей площади
                (гектар))
              </div>
