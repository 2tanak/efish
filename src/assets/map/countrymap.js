...
html5countrymapv4.184 - trial version
...
!(function (t) {
  ...
  t.eve =
    ...
    (m.listeners = function (t) {
      for (
        var e, r, i, n, s, a, o = t.split(p), l = y, h = [l], u = [], c = 0, f = o.length;
        c < f;
        c++
      ) {
    ...
    (m.on = function (t, e) {
      ...
      for (var r = t.split(p), i = y, n = 0, s = r.length; n < s; n++)
        i = ((i = i.n).hasOwnProperty(r[n]) && i[r[n]]) || (i[r[n]] = { n: {} });
  ...
  (function (t) {
    !(function (t, N) {
        ...
        Q = (j.mapPath = function (t, e) {
          ...
          for (var r, i, n, s, a, o = 0, l = (t = Ct(t)).length; o < l; o++)
            for (n = 1, s = (a = t[o]).length; n < s; n += 2)
              (r = e.x(a[n], a[n + 1])), (i = e.y(a[n], a[n + 1])), (a[n] = r), (a[n + 1] = i);
          return t;
        });
      if (
        ((j._g = d),
      ...
      function st(t, e, r, i) {
        return (
          (r = { r: (t *= 255), g: (e *= 255), b: (r *= 255), hex: j.rgb(t, e, r), toString: it }),
        ...
        if (j.vml) {
          ...
          at = ot(function (t) {
            try {
              ...
              return (
                ...
                (
                  '000000' +
                  (e = ((255 & e) << 16) | (65280 & e) | ((16711680 & e) >>> 16)).toString(16)
                ).slice(-6)
              );
            } catch (t) {
              return 'none';
          ...
          (s.title = 'Raphaël Colour Picker'),
            ...
            (at = ot(function (t) {
              return (
                (s.style.color = t),
                d.doc.defaultView.getComputedStyle(s, '').getPropertyValue('color')
              );
            }));
        }
        return at(t);
      ...
      (j.getRGB = ot(function (t) {
        ...
        (j.getColor = function (t) {
          ...
          return (
            (e.h += 0.075),
            1 < e.h &&
              ((e.h = 0), (e.s -= 0.2), e.s <= 0 && (this.getColor.start = { h: 0, s: 1, b: e.b })),
            t.hex
          );
        }),
            ...
            a.length ||
              P(t).replace(G, function (t, e, r) {
                ...
                if (
                  ...
                  'm' == n &&
                    2 < i.length &&
                    (a.push([e][M](i.splice(0, 2))), (n = 'l'), (e = 'm' == e ? 'l' : 'L')),
                  'r' == n)
                )
                  a.push([e][M](i));
      ...
      function pt(t, e, r) {
        ...
        for (c = 0; c < a + 1; c++)
          (f = j.findDotsAtSegment.apply(j, e.concat(c / a))), l.push({ x: f.x, y: f.y, t: c / a });
        for (c = 0; c < s; c++)
          for (var p = 0; p < a; p++) {
            var d = o[c],
              g = o[c + 1],
            ...
            b &&
              ...
              0 <= d &&
                ...
                0 <= x &&
                x <= 1.001 &&
                (r ? u++ : u.push({ x: b.x, y: b.y, t1: k(d, 1), t2: k(x, 1) })));
          }
        return u;
      }
      function dt(t, e, r) {
              ...
              if ('M' == v[0]) (s = h = v[1]), (a = u = v[2]);
                ...
                if (r) p += b;
                  ...
                  for (var _ = 0, w = b.length; _ < w; _++)
                    (b[_].segment1 = d), (b[_].segment2 = y), (b[_].bez1 = c), (b[_].bez2 = f);
                  p = p.concat(b);
                }
              }
            }
      ...
      var vt = (j.pathBBox = function (t) {
        ...
        wt = function (t, e, r, i, n, s, a, o, l, h) {
          ...
          h
            ...
            : ((t = (g = p(t, e, -c)).x),
              ...
              B.cos((T / 180) * n),
              B.sin((T / 180) * n),
              1 < (y = ((x = (t - o) / 2) * x) / (r * r) + ((d = (e - l) / 2) * d) / (i * i)) &&
                ((r *= y = B.sqrt(y)), (i *= y)),
              (g = r * r),
              (y = i * i),
              (m =
                ((g =
                  (s == a ? -1 : 1) *
                  B.sqrt(S((g * y - g * d * d - y * x * x) / (g * d * d + y * x * x)))) *
                  r *
                  d) /
                  i +
                (t + o) / 2),
        ...
        St =
          ((j._tofront = function (t, e) {
            e.top !== t &&
              (Bt(t, e), (t.next = null), (t.prev = e.top), (e.top.next = t), (e.top = t));
          }),
          (j._toback = function (t, e) {
            e.bottom !== t &&
              (Bt(t, e), (t.next = e.bottom), (t.prev = null), (e.bottom.prev = t), (e.bottom = t));
          }),
              ...
              for (var h = 0, u = i.length; h < u; h++) {
                ...
                't' == m && 3 == y
                  ...
                  ? 2 == y
                    ...
                    : 4 == y &&
                      (v
                        ? ((p = b.x(x[2], x[3])), (d = b.y(x[2], x[3])), l.rotate(x[1], p, d))
                        : l.rotate(x[1], x[2], x[3]),
                      (n += x[1]))
                  : 's' == m
                  ? 2 == y || 3 == y
                    ? ((g = g || t.getBBox(1)),
                      l.scale(x[1], x[y - 1], g.x + g.width / 2, g.y + g.height / 2),
                      (s *= x[1]),
                      (a *= x[y - 1]))
                    : 5 == y &&
                      (v
                        ? ((p = b.x(x[3], x[4])), (d = b.y(x[3], x[4])), l.scale(x[1], x[2], p, d))
        ...
        (function (t) {
          ...
          (t.add = function (t, e, r, i, n, s) {
            ...
            (t.split = function () {
              ...
              return (
                e < 0
                  ? ((t.rotate = j.deg(B.acos(e))), r < 0 && (t.rotate = 360 - t.rotate))
              ...
              return t.isSimple
                ? ((t.scalex = +t.scalex.toFixed(4)),
                  ...
                  (t.dx || t.dy ? 't' + [t.dx, t.dy] : '') +
                    (1 != t.scalex || 1 != t.scaley ? 's' + [t.scalex, t.scaley, 0, 0] : '') +
      ...
      o =
        navigator.userAgent.match(/Version\/(.*?)\s/) || navigator.userAgent.match(/Chrome\/(\d+)/);
              ...
              function (t) {
                for (var e = this.events || [], r = e.length; r--; )
                  e[r].name != i ||
                    ...
                    (e[r].unbind(), e.splice(r, 1), e.length || delete this.events);
                return this;
              });
        })(l[Dt]);
        ...
        function t(t) {
          ...
          if (((this._drag.id = t.identifier), g && t.touches))
            for (var s, a = t.touches.length; a--; )
              if (
                ((s = t.touches[a]), (this._drag.id = s.identifier), s.identifier == this._drag.id)
              ) {
          ...
          : j.findDotsAtSegment(
              ...
              (function (t, e, r, i, n, s, a, o, l) {
                if (!(l < 0 || ft(t, e, r, i, n, s, a, o) < l)) {
                  for (var h = 0.5, u = 1 - h, c = ft(t, e, r, i, n, s, a, o, u); 0.01 < S(c - l); )
      ...
      var o = function (p, d) {
          return function (t, e, r) {
            for (
              var i, n, s, a, o, l = '', h = {}, u = 0, c = 0, f = (t = Ct(t)).length;
              c < f;
              c++
            ) {
              if ('M' == (s = t[c])[0]) (i = +s[1]), (n = +s[2]);
                ...
                if (e < u + (a = Yt(i, n, s[1], s[2], s[3], s[4], s[5], s[6]))) {
                  if (d && !h.start) {
                    if (
                      ((l += [
                        'C' + (o = Yt(i, n, s[1], s[2], s[3], s[4], s[5], s[6], e - u)).start.x,
                        o.start.y,
                        o.m.x,
                        o.m.y,
                        o.x,
            ...
            return (
              (h.end = l),
              (o = p ? u : d ? h : j.findDotsAtSegment(i, n, s[0], s[1], s[2], s[3], s[4], s[5], 1))
        ...
        $t = function () {
          for (var t = +new Date(), e = 0; e < Ht.length; e++) {
            ...
            if (!r.el.removed && !r.paused) {
              ...
              if (
                (r.initstatus
                  ? ((n = ((r.initstatus * r.anim.top - r.prev) / (r.percent - r.prev)) * s),
      ...
      (qt.animateWith = function (t, e, r, i, n, s) {
        ...
        (j.animation = function (t, e, r, i) {
          ...
          return n
            ? (r && (a.easing = r), i && (a.callback = i), new Jt({ 100: a }, e))
            : new Jt(t, e);
        }),
        ...
        (qt.pause = function (t) {
          for (var e = 0; e < Ht.length; e++)
            Ht[e].el.id != this.id ||
              (t && Ht[e].anim != t) ||
              (!1 !== N('raphael.anim.pause.' + this.id, this, Ht[e].anim) && (Ht[e].paused = !0));
          return this;
        }),
        ...
        (qt.stop = function (t) {
          for (var e = 0; e < Ht.length; e++)
            Ht[e].el.id != this.id ||
              (t && Ht[e].anim != t) ||
              (!1 !== N('raphael.anim.stop.' + this.id, this, Ht[e].anim) && Ht.splice(e--, 1));
          return this;
        }),
        ...
        re = function (t) {
          if (((this.items = []), (this.length = 0), (this.type = 'set'), t))
            for (var e = 0, r = t.length; e < r; e++)
              !t[e] ||
                (t[e].constructor != qt.constructor && t[e].constructor != re) ||
          ...
          if ((j.is(i, 'string') && (i = this.getFont(i)), i)) {
            ...
            for (
              ...
              '\n' == h[v]
                ...
                : ((p = (c && i.glyphs[h[v - 1]]) || {}),
                  (d = i.glyphs[h[v]]),
                  (u += c ? (p.w || i.w) + ((p.k && p.k[h[v]]) || 0) + i.w * a : 0),
                  (c = 1)),
                d &&
                  d.d &&
        ...
        (function () {
          if (j.svg) {
            ...
            function T(t, e) {
              ...
              return (
                L(a, { fill: 'url(#' + r + ')', opacity: 1, 'fill-opacity': 1 }),
                (l.fill = ''),
                (l.opacity = 1),
                (l.fillOpacity = 1)
              );
            ...
            function N(t, e, r) {
              if ('path' == t.type) {
                ...
                'none' != v
                  ? ((s = 'raphael-marker-' + v),
                    ...
                    j._g.doc.getElementById(s)
                      ? S[s]++
                      : (p.defs.appendChild(
                          L(L('path'), { 'stroke-linecap': 'round', d: B[v], id: s }),
                        ),
                        (S[s] = 1)),
                    ...
                    (h = r
                      ? ((i = t._.arrows.startdx * y || 0), j.getTotalLength(x.path) - l * y)
                      : ((i = l * y), j.getTotalLength(x.path) - (t._.arrows.enddx * y || 0))),
                    ((u = {})['marker-' + d] = 'url(#' + a + ')'),
                  ...
                  : ((h = r
                      ? ((i = t._.arrows.startdx * y || 0), j.getTotalLength(x.path) - i)
                      : ((i = 0), j.getTotalLength(x.path) - (t._.arrows.enddx * y || 0))),
                ...
                S))
                  !S[k](u) ||
                    S[u] ||
                    ((c = j._g.doc.getElementById(u)) && c.parentNode.removeChild(c));
              }
            }
            function E(t, e, r) {
                  ...
                  switch (((n[r] = a), r)) {
                    ...
                    case 'target':
                      ...
                      'a' != h.tagName.toLowerCase() &&
                        ((o = L('a')), h.insertBefore(o, i), o.appendChild(i), (h = o)),
                        'target' == r
                          ? h.setAttributeNS(w, 'show', 'blank' == a ? 'new' : a)
                      ...
                      4 == l.length &&
                        ...
                        a ||
                          ((u = i.getAttribute('clip-path')) &&
                            ((d = j._g.doc.getElementById(u.replace(/(^url\(#|\)$)/g, ''))) &&
                    ...
                    case 'path':
                      'path' == t.type &&
                        ...
                        (t._.dirty = 1),
                        t._.arrows &&
                          ('startString' in t._.arrows && N(t, t._.arrows.startString),
                          'endString' in t._.arrows && N(t, t._.arrows.endString, 1)));
                      break;
                    case 'width':
                    ...
                    case 'cy':
                      ...
                      break;
                    case 'r':
                      'rect' == t.type ? L(i, { rx: a, ry: a }) : i.setAttribute(r, a),
                        (t._.dirty = 1);
                      break;
                    case 'src':
                    ...
                    case 'fill':
                      ...
                      if (p.error) {
                        if (
                          ('circle' == t.type || 'ellipse' == t.type || 'r' != C(a).charAt()) &&
                          T(t, a)
                        ) {
                      ...
                      p[k]('opacity') &&
                        L(i, { 'fill-opacity': 1 < p.opacity ? p.opacity / 100 : p.opacity });
                    case 'stroke':
                      (p = j.getRGB(a)),
                        i.setAttribute(r, p.hex),
                        'stroke' == r &&
                          p[k]('opacity') &&
                          L(i, { 'stroke-opacity': 1 < p.opacity ? p.opacity / 100 : p.opacity }),
                        'stroke' == r &&
                          t._.arrows &&
                          ('startString' in t._.arrows && N(t, t._.arrows.startString),
                          'endString' in t._.arrows && N(t, t._.arrows.endString, 1));
            ...
            var L = function (t, e) {
                if (e)
                  ...
                  (t = j._g.doc.createElementNS('http://www.w3.org/2000/svg', t)).style &&
              ...
              M = function (t, e) {
                if (
                  'text' == t.type &&
                  (e[k]('text') || e[k]('font') || e[k]('font-size') || e[k]('x') || e[k]('y'))
                ) {
                  var r = t.attrs,
                    i = t.node,
                    n = i.firstChild
            ...
            ((o.prototype = t).constructor = o),
              ...
              (t.rotate = function (t, e, r) {
                return (
                  this.removed ||
                    ...
                    null == r && (e = r),
                    (null != e && null != r) ||
                      ((e = (i = this.getBBox(1)).x + i.width / 2), (r = i.y + i.height / 2)),
              ...
              (t.transform = function (t) {
                ...
                return null == t
                  ...
                  : (j._extractTransform(this, t),
                    ...
                    (1 == e.sx && 1 == e.sy) ||
                      ((e = this.attrs[k]('stroke-width') ? this.attrs['stroke-width'] : 1),
              ...
              (j._engine.circle = function (t, e, r, i) {
                ...
                t = new o(n, t);
                return (
                  (t.attrs = { cx: e, cy: r, r: i, fill: 'none', stroke: '#000' }),
                  (t.type = 'circle'),
                  L(n, t.attrs),
                  t
                );
              ...
              (j._engine.ellipse = function (t, e, r, i, n) {
                ...
                t = new o(s, t);
                return (
                  (t.attrs = { cx: e, cy: r, rx: i, ry: n, fill: 'none', stroke: '#000' }),
                  (t.type = 'ellipse'),
                  L(s, t.attrs),
                  t
                );
              ...
              (j._engine.image = function (t, e, r, i, n, s) {
                var a = L('image');
                L(a, { x: r, y: i, width: n, height: s, preserveAspectRatio: 'none' }),
                  a.setAttributeNS(w, 'href', e),
                  t.canvas && t.canvas.appendChild(a);
                t = new o(a, t);
                return (
                  (t.attrs = { x: r, y: i, width: n, height: s, src: e }), (t.type = 'image'), t
                );
              }),
              ...
              (j._engine.create = function () {
                ...
                return (
                  ...
                  1 == e
                    ? ((o.style.cssText = t + 'position:absolute;left:' + r + 'px;top:' + i + 'px'),
              ...
              (j.prototype.renderfix = function () {
                ...
                (i || n) &&
                  ...
                  n && ((this._top = (this._top + n) % 1), (t.top = this._top + 'px')));
              }),
          ...
          if (j.vml) {
            ...
            function p(t, e) {
              ...
              var r,
                ...
                p =
                  z[t.type] &&
                  (u.cx != e.cx || u.cy != e.cy || u.r != e.r || u.rx != e.rx || u.ry != e.ry),
                d = t;
              ...
              if (
                ...
                'clip-rect' in e &&
                  (4 == (i = _(e['clip-rect']).split(T)).length &&
                    ((i[2] = +i[2] + +i[0]),
                    (i[3] = +i[3] + +i[1]),
                    ((s = (n = h.clipRect || j._g.doc.createElement('div')).style).clip = j.format(
                ...
                t.textpath &&
                  ...
                  e['font-family'] &&
                    (o.fontFamily =
                      '"' + e['font-family'].split(',')[0].replace(/^['"]+|['"]+$/g, '') + '"'),
                ...
                (null == e.opacity &&
                    ...
                    ((g = _(e.fill).match(j._ISURL))
                      ...
                      : ((o.color = j.getRGB(e.fill).hex),
                        ...
                        j.getRGB(e.fill).error &&
                          (d.type in { circle: 1, ellipse: 1 } || 'r' != _(e.fill).charAt()) &&
                          I(d, e.fill, o) &&
                          ((u.fill = 'none'), (u.gradient = e.fill), (o.rotate = !1)))),
                  ...
                  h.appendChild(o),
                  (a = !1),
                  (g = h.getElementsByTagName('stroke') && h.getElementsByTagName('stroke')[0]) ||
                    (a = g = R('stroke')),
                    ...
                    return (
                      ...
                      e &&
                        ...
                        0.25 < i(e - 0.5, 2) + i(r - 0.5, 2) &&
                          (r = c.sqrt(0.25 - i(e - 0.5, 2)) * (2 * (0.5 < r) - 1) + 0.5),
                        (s = e + A + r)),
                      ''
                    );
                  })).split(/\s*\-\s*/)),
            ...
            ((u.prototype = t).constructor = u),
              ...
              (t.toFront = function () {
                return (
                  ...
                  this.paper && this.paper.top != this && j._tofront(this, this.paper),
                  this
                );
              }),
              (t.toBack = function () {
...
var simplemaps_countrymap_mapinfo = {
  ...
  default_labels: {},
  proj_coordinates: [
    { lat: 51.1175, x: 291.4, lng: 58.364722, y: 177.7 },
    { lat: 52.8773, x: 729.5, lng: 76.293491, y: 107.8 },
    { lat: 51.0599, x: 287.9, lng: 58.222752, y: 179.9 },
  ],
  initial_view: { x2: 1008.99, x: 0.99, y2: 554.49, y: 0.99 },
};
...
!(function (t) {
  ...
  (function () {
    var t,
      ...
      p = (function () {
        ...
        function d(e, o, i, n, a, r, s) {
          ...
          for (l in o)
            o.hasOwnProperty(l) &&
              ((c = 'function' == typeof (c = s[l]) ? c : t[c]), (o[l] = _(i[l], n[l], c, m)));
          return o;
        }
        function _(t, e, o, i) {
          return t + (e - t) * o(i);
            ...
            t.isPlaying() &&
              (i
                ...
                : ((t._scheduleId = _(t._timeoutHandler, 1e3 / 60)),
                  h(t, 'beforeTween'),
                  o < e + a ? d(1, l, c, m, 1, 1, u) : d(o, l, c, m, r, e + a, u),
                  h(t, 'afterTween'),
                  p(l, t._attachment, n)));
        }
        function v(t, e) {
    ...
    function v(t) {
      for (var e = t.match(n), o = e.length, i = t.match(r)[0], a = 0; a < o; a++)
        i += parseInt(e[a], 10) + ',';
      return i.slice(0, -1) + ')';
    }
    function y(t, o) {
    ...
    p.shallowCopy(p.prototype.formula, {
      ...
      (n = /[0-9.\-]+/g),
      (a = new RegExp(
        'rgb\\(' + n.source + /,\s*/.source + n.source + /,\s*/.source + n.source + '\\)',
        'g',
      )),
      (r = /^.*\(/),
      (s = /#([0-9]|[a-f]){3,6}/gi),
  ...
  var o = (function () {
      ...
      return {
        ...
        findPos: function (t) {
          ...
          for (var i, n, a = (i = 0), r = t, s = !1; (r = r.parentNode) && r != document.body; )
            (a -= r.scrollLeft || 0),
              (i -= r.scrollTop || 0),
  ...
  function p() {
    ...
    if (i && n) {
      ...
      if (!document.getElementById(ct))
        return (
          console.log("Can't find target for map #" + ct + '.  Check mapdata.main_settings.div'), !1
        );
      var mt,
        ut,
        pt,
        ...
        Je = function (t, e) {
          if (t) {
            ...
            if ((je.hide(), Zo(t)))
              t.sm.ignore_hover || t.animate(t.sm.attributes, D, n),
                t.animate(t.sm.adjacent_attributes, D, n),
                Go(t, 'out', !0);
            else {
              if (it && 'location' == t.sm.type && 'image' == t.sm.shape_type) return;
              if (!t || !t.sm) return;
              t.sm.ignore_hover ||
                (i ? (t.attr(t.sm.attributes), n()) : t.animate(t.sm.attributes, D, n)),
                Go(t, 'out');
            }
          } else e();
          function n() {
            ...
            var i = function (e) {
              var i = nt ? event.clientX + document.documentElement.scrollLeft : e.pageX,
                ...
                d =
                  ...
                  ',';
              t && console.log(d), po('click_xy', [{ x: u, y: p }]);
            };
        ...
        ao = function (t) {
          var e = t.sm.type;
          'state' == e && po('over_state', [t.sm.id]),
            'location' == e && po('over_location', [t.sm.id]),
            'region' == e && po('over_region', [t.sm.id]);
        },
        ro = function (t) {
          var e = t.sm.type;
          'state' == e && po('out_state', [t.sm.id]),
            'location' == e && po('out_location', [t.sm.id]),
            'region' == e && po('out_region', [t.sm.id]);
        },
        so = function (t, e) {
          var o = t.sm.type;
          'state' == o && po('click_state', [t.sm.id, e]),
            'region' == o && po('click_region', [t.sm.id, e]),
            'location' == o && po('click_location', [t.sm.id, e]);
        },
        lo = function (t, e) {
          var o = t.sm.type;
          'state' == o && po('preclick_state', [t.sm.id, e]),
            'region' == o && po('preclick_region', [t.sm.id, e]),
            'location' == o && po('preclick_location', [t.sm.id, e]);
        },
        co = function (t, e) {
          var o = t.sm.type;
          'state' == o && po('zoomable_click_state', [t.sm.id, e]),
            'region' == o && po('zoomable_click_region', [t.sm.id, e]);
        },
        mo = !1,
        uo = ((mo = !1), !1);
      uo = !1;
    ...
    function _o() {
      (C = !(!_.background_image_url || 'no' == _.background_image_url) && _.background_image_url),
        ...
        (tt = _.popup_corners ? _.popup_corners : 5),
        (et = 'yes' == _.popup_nocss),
        (J = !!_.popup_maxwidth && _.popup_maxwidth),
        (ot = _.popup_font ? _.popup_font : '12px/1.5 Verdana, Arial, Helvetica, sans-serif'),
    ...
    function vo(t) {
      if (
        ...
        (ft.style.width = ''),
        b
          ? ((xt = ht.offsetWidth) < 1 && (xt = ht.parentNode.offsetWidth),
            (ft.style.width = xt + 'px'))
          : ((xt = void 0 === _.width ? 800 : _.width), (ht.style.width = xt + 'px')),
        (xt *= 1),
        n.calibrate
          ? (((Et = {}).x = -1 * n.calibrate.x_adjust),
            (Et.y = -1 * n.calibrate.y_adjust),
            (Et.x2 = Et.x + n.calibrate.width),
            (Et.y2 = (Et.x2 - Et.x) / n.calibrate.ratio))
          : (Et = n.initial_view),
        (zt = Et.x2 - Et.x),
        (Mt = Et.y2 - Et.y),
        (wt = xt / (Tt = zt / Mt)),
        (At = zt / 1e3),
        (_t.style.height = wt + 'px'),
        !t)
      ) {
        if (((kt = xt / zt), (Ct = 1), y)) {
          var e = [];
    ...
    function yo(t, e, o) {
      if ((void 0 === o && (o = 'location' == t ? 4 : 1), 'location' == t)) var i = ze[e];
      else if ('state' == t) i = fe[e];
      else {
      ...
      var n = function () {
        ...
        (i.sm.on_click = !0),
          (i.sm.content = jo(i)),
          mi(i.sm.type, i.sm.id, function () {
            (i.sm.on_click = t), (i.sm.content = jo(i));
          });
      };
      if ('state' == t) {
        function a() {
          i.sm.zoomable || i.sm.region ? si(i.sm.id, n) : n();
        }
        Je(z, a);
      } else if ('location' == t) {
        function a() {
        ...
        function a() {
          !(function (t, e, o) {
            void 0 === e && (e = 4);
            void 0 === o && (o = function () {});
            Po({ sm: { type: 'manual', zp: e, bbox: t } }, !1, function () {
              o(), xo();
            });
          })(i.sm.bbox, 1, n);
        }
      ...
      if (r)
        if (location.hostname.match('simplemaps.com')) r = !1;
          ...
          (Le.style.cssText =
            ...
            _t.appendChild(Le),
            (Le.innerHTML =
              '<a style="overflow: visible !important; clip-path: none !important; opacity: 1 !important;  filter: opacity(1) !important; transform: none !important; display: block !important; visibility: visible !important; font: 18px Verdana, Arial, Helvetica, sans-serif !important; cursor: pointer !important; font-weight: bold !important; float: right !important; color: #000000 !important; text-decoration: none !important;" href="http://simplemaps.com" title="For evaluation use only.">Simplemaps.com Trial</a>'),
            nt || (503 != Le.innerHTML.length && (_t.innerHTML = ''));
        }
    }
    function bo() {
      Zt.hide(), (dt.style.display = 'none');
    }
    function xo() {
      Zt.show(), (dt.style.display = 'block');
    }
    function wo() {
      var e,
        o,
      ...
      !(function () {
        ...
        function _() {
          if (c) {
            ...
            (f = o), p.attr({ cursor: 'pointer' }), Zt.push(p), Zt.click(Pe);
          } else {
            Ut = Raphael(dt, s, u);
          ...
          j || bo(),
            ...
            g &&
              (function () {
                ...
                function _(t, e) {
                  if ((void 0 === e && (e = 'z'), z && 'region' != z.sm.type))
                    Oe.call(z, !0, function () {
                      (z = !1), _(t);
                    });
                  else {
                    if (
                      ...
                      !(function (t) {
                        ...
                        if (-1 != x && ('manual' == ye.sm.type || w)) {
                          ...
                          if (o && n) {
                            var a = No(ye, ve[x]);
                            if (a || w) return Po(ve[x]), !1;
                          }
                        }
                        if (o && e > ve[-1].sm.zooming_dimensions.w - 1) return w || Po(ve[-1]), !1;
                        return !0;
                      })(t)
                    )
                      return;
                    ...
                    de &&
                      (((ye = { sm: { type: 'manual', zp: 1 } }).sm.zooming_dimensions = _e),
                      (ye.sm.bbox = {
                        x: _e.x / kt,
                        y: _e.y / kt,
                        width: _e.w / kt,
                    ...
                    var i = (function (t, e) {
                      ...
                      if ('x' == e)
                        var n = ye.sm.zooming_dimensions.x + ye.sm.zooming_dimensions.w * t;
                      else if ('y' == e)
                        var a = ye.sm.zooming_dimensions.y + ye.sm.zooming_dimensions.h * t;
                      else
                        var o = ye.sm.zooming_dimensions.w / t,
                      ...
                      return { x: n, y: a, w: o, h: i, r: o / (zt * kt) };
                    })(t, e);
                    if (!i) return;
                    (o.sm.zooming_dimensions = i), Po(o);
                  }
                }
                Jt.transform(c),
                  (vt.style.top = f + 2 * v + 'px'),
                  (vt.style.left = v + 'px'),
                  (Jt = St.set()).push(u, p),
                  ($t = function () {
                    _(B);
    ...
    function ko() {
      ...
      !(function () {
        ...
        if (
          ...
          (t.hover_opacity = _.region_hover_opacity ? _.region_hover_opacity : 0.6),
          (t.url = !1),
          (t.description = !1),
          ...
          (t.popup = _.region_popups ? _.region_popups : ut),
        ...
        for (var n in E)
          for (var a in ((ne[n] = Object.create(t)), E[n].url && (ne[n].zoomable = !1), E[n]))
            'default' != E[n][a] && (ne[n][a] = E[n][a]),
              'yes' == E[n][a] && (ne[n][a] = !0),
              'no' == E[n][a] && (ne[n][a] = !1);
      })(),
        (function () {
          for (var t in ((ce = function (t) {
            ...
            (e.color = _.state_color),
              ...
              (e.image_position = _.state_image_position ? _.state_image_position : 'center'),
              ...
              (e.image_background_opacity = _.image_background_opacity
                ...
                : '1'),
              (e.image_hover_url = !!_.state_image_hover_url && _.state_image_hover_url),
              (e.image_hover_size = _.state_image_hover_size ? _.state_image_hover_size : 'auto'),
              (e.image_hover_position = _.state_image_hover_position
                ? _.state_image_hover_position
                : 'center'),
              (e.image_hover_x = _.state_image_hover_x ? _.state_image_hover_x : '0'),
              (e.image_hover_y = _.state_image_hover_y ? _.state_image_hover_y : '0'),
              (e.image_hover_color = !!_.state_image_hover_color && _.state_image_hover_color),
            ...
            (e.pulse_color = !(!o || 'auto' == o) && o),
              ...
              (e.border_hover_color = !!_.border_hover_color && _.border_hover_color),
              (e.border_hover_size = !!_.border_hover_size && _.border_hover_size),
              (e.emphasize = 'yes'),
              (e.zoom_percentage = R),
              (e.zoomable = 'yes' == _.all_states_zoomable),
              (e.popup = _.state_popups ? _.state_popups : ut),
              (e.opacity = _.state_opacity ? _.state_opacity : 1),
              (e.hover_opacity = _.state_hover_opacity ? _.state_hover_opacity : 1),
              (e.description_mobile = !!_.state_description_mobile && state_description_mobile),
              e.pu,
              (e.path = !1);
            var i = !!re[t] && re[t];
            for (var n in (i && ne[i].hide && (e.hide = !0),
            i &&
              ne[i].cascade &&
              (ne[i].color && (e.color = ne[i].color),
              ne[i].hover_color && (e.hover_color = ne[i].hover_color),
              ne[i].description && (e.description = ne[i].description),
              ne[i].url && (e.url = ne[i].url),
              ne[i].inactive && (e.inactive = ne[i].inactive),
              ne[i].hide && (e.hide = ne[i].hide)),
            (oe[t] = Object.create(e)),
            'us' != a ||
          ...
          for (var t in i.state_specific)
            i.state_specific[t] && i.state_specific[t].path && (ae[t] = !0);
        ...
        (function () {
          ...
          (t.font_family = _.label_font ? _.label_font : 'arial,sans-serif'),
            ...
            (t.hover_color = _.label_hover_color ? _.label_hover_color : t.color),
            (t.opacity = _.label_opacity || '0' == _.label_opacity ? _.label_opacity : 1),
            (t.hover_opacity = _.label_hover_opacity ? _.label_hover_opacity : t.opacity),
            (t.size = Q),
            ...
            (t.line_color = _.label_line_color ? _.label_line_color : '#000000'),
          ...
          var e = 'no' == _.import_labels ? {} : n.default_labels,
            o = function (o) {
              for (var i in ((se[o] = Object.create(t)), e[o]))
                'default' != e[o][i] && (se[o][i] = e[o][i]),
                  'yes' == e[o][i] && (se[o][i] = !0),
                  'no' == e[o][i] && (se[o][i] = !1);
            },
            i = function (e) {
              for (var o in (se[e] || (se[e] = Object.create(t)), q[e]))
                'default' != q[e][o] && (se[e][o] = q[e][o]),
                  'yes' == q[e][o] && (se[e][o] = !0),
                  'no' == q[e][o] && (se[e][o] = !1);
            };
          for (var a in e) o(a);
        ...
        (function () {
          var t = {},
            e = mt ? (_.scale_limit_mobile ? _.scale_limit_mobile : 0.4) : 0.0625;
          (t.scale_limit = _.scale_limit ? _.scale_limit : e),
            (t.color = _.location_color ? _.location_color : '#FF0067'),
            (t.hover_color = !!_.location_hover_color && _.location_hover_color),
            (t.border = _.location_border ? _.location_border : 1.5),
            (t.border_color = _.location_border_color ? _.location_border_color : '#FFFFFF'),
            (t.hover_border = _.location_hover_border ? _.location_hover_border : 2),
            (t.size = _.location_size),
            (t.description = _.location_description),
            (t.description_mobile = !!_.location_description_mobile && location_description_mobile),
            ...
            (t.pulse_speed = _.location_pulse_speed ? _.location_pulse_speed : 0.5);
          var o = _.location_pulse_color;
          for (var i in ((t.pulse_color = !(!o || 'auto' == o) && o),
          (t.image_source = _.location_image_source ? _.location_image_source : ''),
          (t.hide = _.all_locations_hide ? _.all_locations_hide : 'no'),
          (t.opacity = U),
          (t.scale = !_.location_scale || _.location_scale),
          (t.hover_opacity = !!_.location_hover_opacity && _.location_hover_opacity),
          (t.image_source = _.location_image_source ? _.location_image_source : ''),
          (t.image_url = !!_.location_image_url && _.location_image_url),
          (t.image_position = _.location_image_position ? _.location_image_position : 'center'),
          (t.image_hover_source = _.location_image_hover_source
            ? _.location_image_hover_source
            : ''),
          (t.image_hover_url = !!_.location_image_hover_url && _.location_image_hover_url),
          (t.image_hover_position = _.location_image_hover_position
            ? _.location_image_hover_position
            : 'center'),
          (t.popup = _.location_popups ? _.location_popups : ut),
          (t.x = !1),
          (t.y = !1),
          ...
          le)) {
            for (var n in ((ie[i] = Object.create(t)), le[i]))
              'overwrite_image_location' != n
                ? ('region' == n && (ie[i].display = 'region'),
                  'default' != le[i][n] && (ie[i][n] = le[i][n]),
                  'yes' == le[i][n] && (ie[i][n] = !0),
                  'no' == le[i][n] && (ie[i][n] = !1))
                : (ie[i].image_url = le[i][n]);
            ie[i].hover_opacity || (ie[i].hover_opacity = ie[i].opacity),
              ie[i].hover_color || (ie[i].hover_color = ie[i].color);
          }
        })(),
        (function () {
          var t = {};
          ...
          for (var o in e)
            for (var n in ((ue[o] = Object.create(t)), e[o]))
              'default' != e[o][n] && (ue[o][n] = e[o][n]),
                'yes' == e[o][n] && (ue[o][n] = !0),
                'no' == e[o][n] && (ue[o][n] = !1);
        })();
    }
        ...
        var r,
          ...
          S =
            ...
            (b =
              s +
              ((p = m - s) *
                (_ = (l * l - (u = T) * u + (d = Math.sqrt(p * p + g * g)) * d) / (2 * d))) /
                d),
            {
              opt1: {
    ...
    function Mo(t) {
      ...
      return (
        ...
        (a -= 0.5 * (s / l - s)),
        (r /= l) / (s /= l) > Tt
          ? ((a -= (m * (e = r / c) - s) / 2), (s = r / Tt))
          : ((n -= (c * (e = s / m) - r) / 2), (r = s * Tt)),
        { x: n, y: a, w: r, h: s, r: e }
      );
    }
    function Eo(t) {
      if (t) {
        ...
        for (var e = 0; e < t.sm.states.length; ++e) {
          ...
          o.attr(o.sm.attributes), Go(o, 'reset', !1, 'state');
        }
      }
    }
    function Ao(t) {
      if (t) {
        ...
        for (var e = 0; e < t.sm.states.length; ++e) {
          Go(fe[t.sm.states[e]], 'reset', !1, 'region');
        }
      }
    }
    function Co() {
          ...
          Yt.hide(),
            Yt.forEach(function (o) {
              o.sm.hide ||
                (To(o, t) && o.show(),
                o.sm.scale &&
                  So(o, Qo(o, (Ct > o.sm.scale_limit ? Ct : o.sm.scale_limit) * kt), e));
            });
        })(t, e),
        (function (t, e) {
          for (var o in (Xt.hide(), be)) {
            var i = be[o];
            if (!i.sm.hide) {
              if ((To(i, t) && xe[i.sm.id].show(), i.sm.line)) {
                var n = Vo(i);
                i.sm.line.attr({ path: n, transform: Rt });
              }
              if (i.sm.scale) {
                var a = Qo(i, (Ct > i.sm.scale_limit ? Ct : i.sm.scale_limit) * kt);
                So(i, a, e), i.sm.pill && So(ke[i.sm.id], a, e);
              }
            }
          }
        })(t, e),
        o.x_in_array(i, ['state', 'region', 'out']) && Co(),
        'region' == i
          ? Eo(t)
          : 'state' == i
          ? Eo(ve[t.sm.region])
          : 'manual' == i &&
            Wt.forEach(function (t) {
              -1 != t.sm.id && (t.sm.zooming_dimensions.r > Ct && t.sm.zoomable ? Eo(t) : Ao(t));
            }),
        'out' != i && 'manual' != i
          ? (qt.stop(),
            Ht.stop(),
            qt.attr({ 'fill-opacity': W }),
            Ht.attr({ 'fill-opacity': W }),
            t.stop(),
            t.attr({ 'fill-opacity': 1 }),
            t.sm.labels.forEach(function (t) {
              t.sm && t.sm.pill && (t.sm.pill.stop(), t.sm.pill.attr({ 'fill-opacity': 1 }));
            }),
            t.animate({ 'stroke-width': t.sm.border_hover_size * (xt / zt) * At * 1.25 }, 1e3 * S))
          : (qt.attr({ 'fill-opacity': 1 }), Ht.attr({ 'fill-opacity': 1 })),
        qt.animate({ 'stroke-width': Z * (xt / zt) * At * 1.25 }, 1e3 * S);
    }
    function Bo(t) {
      if (w && '-1' != x && 'region' == t.sm.type) {
        ...
        'state' == t.sm.type || 'region' == t.sm.type || j ? xo() : g && 'out' != t.sm.type && xo();
    }
    function Fo(t) {
    ...
    function Po(i, n, a) {
      if (!He) {
        Io(),
          ...
          (M = !1),
          (He = !0),
          (i.sm.zooming_dimensions = Mo(i));
        var r = Fo(i.sm.zooming_dimensions),
          s = Fo(ye.sm.zooming_dimensions);
        if (((Ct = i.sm.zooming_dimensions.r), Oo(i, n), it || (mt && !O) || n))
          (_e = r), St.setViewBox(r.x, r.y, r.w, r.h, !1), c();
        else {
      ...
      function c() {
        Bo(i),
          ...
          (He = !1),
          (rt = !1),
          (t.zoom_level = ye.sm.type),
          (t.zoom_level_id = !!ye.sm.id && ye.sm.id),
          po('zooming_complete', []),
          o.isFunction(a) && a();
      }
    }
    ...
    function jo(t) {
      var e = t.sm.description,
        i = it
          ? '<a style="line-height: 1.5" id="xpic_sm_' + ct + '">X</a>'
          : '<a id="xpic_sm_' +
            ct +
      ...
      return (
        '<div class="tt_sm"><div>' +
        (t.sm.hide_name ? '' : '<div class="tt_name_sm">' + t.sm.name + '</div>') +
        i +
    ...
    function Lo(t, e) {
      ...
      d.setAttribute('fill', '#ffffff'),
        ...
        p.setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href', e.image_url),
        m.appendChild(d),
        m.appendChild(p),
        c.appendChild(m),
        s.appendChild(c);
          ...
          var n,
            ...
            r = (function () {
              ...
              return (
                f
                  ? v || g
                    ? (n = i > 1 ? (t > w ? 1 : t / w) : o > k ? 1 / z : o / k / z)
                    : b && ((n = i / z), (n = i > z ? n : 1 / n))
                  : n > 1 && (n = (e.image_size * At) / w),
                n
              );
            })(),
            s = w * r,
    ...
    function Do(t) {
      ...
      for (var o in ((he = function (t) {
        var o = !fe[t],
          ...
          r = o ? St.path(a) : fe[t];
        o && (r.sm = { id: t }), it || r.node.setAttribute('class', 'sm_state_' + t);
        var s = {
            fill: i.color,
            opacity: i.opacity,
        ...
        i.inactive && (s.cursor = 'default'),
          i.image_source &&
            ((r.sm.ignore_hover = !0), (s.fill = 'url(' + p + i.image_source + ')')),
    ...
    function Ho() {
      Lt.attr({ fill: _.background_color, 'fill-opacity': Y, stroke: 'none' });
    }
    function qo(t) {
      if ((t || (ve = {}), E))
        for (var e in E) {
            ...
            for (var r = [], s = 0; s < n.states.length; s++) {
              ...
              c
                ? c.sm.region
                  ...
                  : ((c.sm.region = e),
                    a.sm.states.push(l),
                    (it && c.sm.ignore_hover && (i.color || i.hover_color)) || a.push(c),
                    r.push(c.sm.bbox))
                : console.log(l + ' does not exist');
            }
            i.x && i.y && i.x2 && i.y2 && (r = [{ x: i.x, y: i.y, x2: i.x2, y2: i.y2 }]),
      ...
      if (!t) {
        ...
        if (
          ...
          (d.height = d.y2 - d.y),
          (p.sm.bbox = d),
          (p.sm.zooming_dimensions = Mo(p)),
          (ye = p),
          'object' == typeof x
            ? (((ge = {}).sm = { type: 'manual', zp: 1, bbox: x }),
              (ge.sm.zooming_dimensions = Mo(ge)),
              (x = -1),
              (w = !1))
            : -1 == x ||
              x in ve ||
          ...
          var h = Mo(ve[x]),
            ...
            g = h.w * (v - 1) * 0.5,
            b = h.h * (v - 1) * 0.5;
          _.sm.zooming_dimensions = { x: h.x - g, y: h.y - b, w: f * v, h: y * v, r: v };
        }
      }
    }
    function Wo(t) {
    ...
    function Yo() {
      for (var t in (o.clear_sets([Xt, Ot, Ht]),
      (be = {}),
      (ke = {}),
      (xe = {}),
      (se = se.reverse()),
        ...
        if (se.hasOwnProperty(t)) {
          ...
          if (
            ('state' == e.parent_type
              ...
              ? (m = ve[e.parent_id])
              : 'location' == e.parent_type && (m = ze[e.parent_id]),
            !e.x && !e.y && m)
          )
          ...
          if ((e.parent_type, m)) {
            ...
            (v.sm = {}),
              ...
              (v.sm.parent = m),
              m.sm.labels.push(v),
              m.sm.region && ve[m.sm.region].sm.labels.push(v);
            var y = {
                'stroke-width': 0,
                fill: e.color,
                'font-size': e.size,
            ...
            if (
              ...
              (e.line || e.pill || u) && (v.sm.bbox = Wo(v)),
              'auto' == e.display && 'state' == e.parent_type)
            ) {
              (v.sm.display = 1e-4), v.sm.bbox || (v.sm.bbox = Wo(v));
            ...
            if ('state' == m.sm.type && e.pill) {
              ...
              if (
                ...
                m.sm.image && (G.sm.attributes.fill = oe[m.sm.id].color),
                (G.sm.over_attributes = o.clone(m.sm.over_attributes)),
                m.sm.image && (G.sm.over_attributes.fill = oe[m.sm.id].hover_color),
            ...
            if (
              (('out' != v.sm.display && 'all' != v.sm.display) || v.sm.hide
                ? s.hide()
                : Pt.push(s),
              'location' != v.sm.parent.sm.type || v.sm.line || Ft.push(s),
              Xt.push(s),
              (xe[t] = s),
              it || v.node.setAttribute('class', 'sm_label_' + t),
              u)
            ) {
              var K =
                  ((_.location_auto_padding ? 1 + 2 * _.location_auto_padding : 1.3) *
                    v.sm.bbox.width) /
                  At,
      ...
      (Me = function (t) {
        ...
        if ('circle' == s)
          ...
          var b = l,
            ...
            w = u.x - x / 2,
            k = u.y - b / 2;
          (_ = St.rect(w, k, x, b)), (h = { x: w, y: k, x2: w + x, y2: k + wt });
        }
        (_.sm = {}),
          (_.sm.image = 'image' == s),
          (_.sm.attributes = a),
          _.attr(a),
          (_.sm.original_transform = Rt),
        ...
        (_.sm.underlay = z),
          ...
          _.transform(Qo(_, Ct * kt)),
          ('region' == _.sm.display || 'state' == _.sm.display || n.hide) && _.hide(),
          (_.sm.content = jo(_)),
          z ? Qt.push(_) : Vt.push(_),
          Yt.push(_),
          (ze[t] = _),
          it || _.node.setAttribute('class', 'sm_location_' + t);
      }),
      le))
        Me(e);
    }
      ...
      return n
        ? 'out' == o
          ...
          ? i == n.sm.id
            ...
            : n
          : 'state' == o
          ? fe[i].sm.region === n.sm.id
            ? e
            : n
          : 'manual' == o
          ? Ct > n.sm.zooming_dimensions.r || !n.sm.zoomable
            ? n
            : e
          : void 0
        : e;
      ...
      t.sm.labels &&
        t.sm.labels.forEach(function (t) {
          if (t.sm) {
            var n = t.sm.pill;
            'over' == e
              ? (t.stop(), Ue(t, 'over'), n && Ze(n, 'over'))
              : ('reset' != e && 'out' != e) ||
                (Ue(t, 'out'), n && (Ze(n, 'out', i), o && Ze(n, 'adjacent', i)));
          }
        });
    }
    function Jo() {
      (Be = function () {
        ...
        (Ee = function (t, e) {
          if (t.sm.pulse || e) {
            ...
            if (!('location' != t.sm.type || 'image' == o || Ct < 0.05)) {
              var i = t.clone();
        ...
        (Se = function () {
          if ((go(), no(), ci(), (this.id || 'set' != !this.type) && !Ge && !mo)) {
            var t = Uo(this);
            ...
            if (((Ne = t.sm.popup_off), !(qe || We || He || (M && rt)))) {
              ...
              if (
                ...
                if (
                  ...
                  if (!M) {
                    if ((t.stop(), it && 'location' == t.sm.type && 'image' == t.sm.shape_type))
                      return;
                    t.sm.ignore_hover || (Ue(t, 'over'), Ee(t)), Go(t, 'over');
                  }
                } else {
                  if (
                    (je.show(t),
                    t.stop(),
                    it && 'location' == t.sm.type && 'image' == t.sm.shape_type)
                  )
                    return;
                  t.sm.ignore_hover || (Ue(t, 'over'), Go(t, 'over'), Ee(t), Ae(t));
                }
            }
          }
        }),
        (Oe = function (t, e) {
          if (
            ...
            !He && !mo && ((Ke = !1), this.id || 'set' != !this.type))
          ) {
            var o = Uo(this);
            if (o && !o.sm.inactive)
              if ((ro(o), rt)) (M && !0 !== t) || (Je(o, e), ($e = o));
                ...
                if ((je.hide(), Zo(o))) {
                  if (He) return !1;
                  o.sm.ignore_hover || Ue(o, 'out', !0), Ue(o, 'adjacent', !0), Go(o, 'out', !0);
                } else {
                  if (it && 'location' == o.sm.type && 'image' == o.sm.shape_type) return;
                  o.sm.ignore_hover || Ue(o, 'out', !0), Go(o, 'out');
                }
                Je(o, e);
              }
          }
      ...
      (Te = function (o) {
        if (!(He || qe || We)) {
          ...
          if (!i.sm.inactive && (lo(i, o), !t.ignore_clicks)) {
            ...
            if (
              (rt && je.update_pos(),
              (Ne = i.sm.popup_off),
              !i.sm.zoomable || ('region' != i.sm.type && ye == i && 'out' != i.sm.type))
            )
              if (rt) {
                if (
                  (z == i ||
                  ...
                  var n = Ko(o);
                  je.pos(o, { l: n.x, u: n.y });
                }
                je.show(i),
                  (M = !0),
                  Go(i, 'over'),
                  Ee(i),
                  (it && 'location' == i.sm.type && 'image' == i.sm.shape_type) ||
                    i.sm.ignore_hover ||
                ...
                a &&
                  (a.onclick = function () {
                    return (
                      je.hide(), (M = !1), z.sm && Oe.call(z), (rt = !1), po('close_popup', []), !1
                    );
                  });
              } else {
                so(i, o);
                ...
                if ('' != r && !uo) {
                  ...
                  return !X || s
                    ...
                    : (window.open(r, '_blank'), void je.hide());
                }
              }
            else
              co(i, o),
        ...
        (Ie = function (t) {
          if (
            (void 0 === t && (t = !1),
            po('back', []),
            ('out' == ye.sm.type || ('region' == ye.sm.type && w)) && j)
          )
            window.location.href = 'javascript:' + j;
          else if (V && 'state' == ye.sm.type && ye.sm.region)
            z
              ? Oe.call(z, !0, function () {
                  Po(ve[ye.sm.region]);
                })
              : Po(ve[ye.sm.region], !1, t);
          else {
            var e = No(ye, ve[x]),
    ...
    function Ko(t) {
      ...
      return { x: nt ? t.clientX + document.documentElement.scrollLeft : t.pageX, y: o };
    }
    function $o() {
      var t = !1;
      function e(e) {
      ...
      o.addEvent(ft, 'touchstart', e),
        o.addEvent(ft, 'touchmove', e),
        o.addEvent(ft, 'touchend', function (e) {
          (t = !1),
            setTimeout(function () {
              We = !1;
            }, 100);
    ...
    function ei(t) {
      if (!t) {
        at
          ? (qt.mouseup(Te), Nt.mouseup(to), Zt.mouseup(Pe), Nt.mouseup(ci))
          : (qt.hover(Se, Oe), qt.click(Te), Nt.click(to), Zt.click(Pe), Nt.hover(ci, ci)),
          b &&
            (function () {
              function t() {
                oi();
              ...
              (Re = function () {
                ...
                window.addEventListener
                  ? (window.addEventListener('resize', Re, !1),
                    window.addEventListener('orientationchange', Re, !1))
                  : (window.attachEvent('resize', Re, !1),
                    window.attachEvent('orientationchange', Re, !1));
              it &&
            ...
            (function () {
              function t(t) {
                var o = Ko(t),
                  ...
                  c = 5 * e.r;
                return (
                  (Math.abs(s) > c || Math.abs(l) > c) && (qe = !0),
              ...
              function r(t) {
                ...
                t.preventDefault ? t.preventDefault() : (t.returnValue = !1),
                  (e = { x: _e.x, y: _e.y, w: _e.w, h: _e.h, r: _e.w / zt / kt }),
                  (a = !0);
                var o = Ko(t);
                (i = o.x), (n = o.y), je.hide(), je.pos(t, { l: i, u: n });
              }
              function s(e) {
              ...
              function l(e) {
                ...
                St.setViewBox(o.x, o.y, o.w, o.h),
                  (_e = o),
                  ((ye = { sm: {} }).sm.zooming_dimensions = _e),
                  (ye.sm.type = 'manual'),
                  (a = !1),
                  setTimeout(function () {
                    qe = !1;
              ...
              o.addEvent(_t, 'mousedown', r),
                o.addEvent(_t, 'mousemove', s),
                o.addEvent(_t, 'mouseup', l),
                o.addEvent(_t, 'mouseleave', l),
                o.addEvent(_t, 'touchstart', r),
                o.addEvent(_t, 'touchmove', s),
                o.addEvent(_t, 'touchend', l);
            })(),
            $o()),
          (ht.mouseIsOver = !1),
      ...
      Yt.hover(Se, Oe),
        ...
        Xt.hover(Be, Fe),
        Xt.click(Ce),
        g && (Yt.touchend(Te), Yt.touchstart(Te), Xt.touchend(Ce));
    }
    function oi() {
      if (!(ht.offsetWidth < 1)) {
          ...
          (qt.forEach(function (e) {
            e.attr({ 'stroke-width': t }),
              ...
              (e.sm.over_attributes['stroke-width'] =
                e.sm.border_hover_size * (xt / zt) * At * 1.25);
          }),
          Yt.forEach(function (t) {
            'image' != ie[t.sm.id].type &&
              ((t.sm.attributes['stroke-width'] = ie[t.sm.id].border * (xt / zt) * At * 1.25),
              (t.sm.over_attributes['stroke-width'] =
                ie[t.sm.id].hover_border * (xt / zt) * At * 1.25),
    ...
    function ii(t) {
      ...
      Nt.show(), Bt.show(), Pt.show(), It.show(), t || !v || Qe || ge || Po(ve[x]);
    }
    function ni(t) {
      _o(),
        ko(),
    ...
    function ai(e) {
      ...
      (function () {
        ...
        (c = 'no' != _.back_image_url && _.back_image_url),
          ...
          (p = u || e.substring(0, e.lastIndexOf('/usmap.js') + 1) + 'map_images/'),
          !c && o && (c = p + o);
      })(),
      (it = 'VML' == Raphael.type),
      (nt = !!window.document.documentMode),
      (at = !!o.isMobile.iOS()),
      (mt = !!o.isMobile.any()),
      (ut = _.pop_ups ? _.pop_ups : _.popups),
      (pt = void 0 === _.mobile_scaling && 'no' != _.mobile_scaling ? 1 : _.mobile_scaling),
      (rt = !1),
      (Ne = fo(ut)),
      (ct = void 0 === _.div ? 'map' : _.div),
      ...
      (function () {
        ...
        : (_o(),
          (function () {
            if (
              ((ht = document.getElementById(ct)),
              (ft =
                !!document.getElementById(ct + '_holder') &&
                document.getElementById(ct + '_holder')))
            ) {
              ht.removeChild(ft);
          ...
          (function () {
            if (
              ((St = Raphael(_t, xt, wt)),
              (Nt = St.set()),
              (Lt = St.rect(Et.x - 2 * zt, Et.y - 2 * Mt, 5 * zt, 5 * Mt)),
              C)
            ) {
            ...
            Nt.push(Lt),
              ...
              (Ht = St.set()),
              (Ot = St.set()),
              St.set().push(qt, Yt, Nt, Xt, It);
          })(),
          go(),
          (function () {
            ((De = document.createElement('div')).style.cssText =
            ...
            if (l) {
              ...
              (e.href = 'http://www.openstreetmap.org/copyright'),
          ...
          (je = {
            create: function () {
              (B = document.createElement('div')).setAttribute('id', 'tt_sm_' + ct),
                (B.style.position = 'absolute'),
                (B.style.display = 'none'),
                _t.appendChild(B),
                (_t.onmousemove = this.pos),
            ...
            show: function (t) {
              Ne ||
                ...
                (B.style.zIndex = 2),
                (B.style.maxWidth = pe + 'px'),
                (B.innerHTML = t.sm.content),
                je.update_pos(t));
            },
            ...
            pos: function (t, e) {
              e
                ? ((r = e.u), (m = e.l))
                : ((r = nt ? event.clientY + document.documentElement.scrollTop : t.pageY),
                  (m = nt ? event.clientX + document.documentElement.scrollLeft : t.pageX)),
                (r -= j),
                (m -= R),
                Ne || k || h || (M && rt) || je.set_pos(r, m);
            },
            set_pos: function (t, e, o) {
              if (B) {
                ...
                if ((o && o.sm.on_click && ('yes' == I || ('auto' == I && xt < 401))) || i) {
                  ...
                  if (((O = 0 + 0.5 * wt), e > (S = 0 + 0.5 * xt) && t > O)) r = 4;
                  else if (e < S && t > O) r = 3;
                  else if (e > S && t < O) r = 2;
                  else var r = 1;
                  'below' == P
                    ...
                    1 == r
                      ? ((B.style.bottom = 'auto'),
                        (B.style.top = t + 5 + 'px'),
                        (B.style.left = e + 5 + 5 + 'px'),
                        (B.style.right = 'auto'))
                      : 2 == r
                      ? ((B.style.bottom = 'auto'),
                        (B.style.top = t + 5 + 'px'),
                        (B.style.right = xt - e + 5 + 'px'),
                        (B.style.left = 'auto'))
                      : 3 == r
                      ? ((B.style.bottom = wt - t + 5 + 'px'),
                        (B.style.top = 'auto'),
                        (B.style.left = e + 5 + 3 + 'px'),
                        (B.style.right = 'auto'))
                      : ((B.style.bottom = wt - t + 5 + 'px'),
                        (B.style.top = 'auto'),
                        (B.style.right = xt - e + 5 + 'px'),
            ...
            Xo(),
                ...
                if (t) {
                  for (var e in t) {
                    ...
                    _.transform(Rt),
                      ...
                      it || _.node.setAttribute('class', 'sm_line_' + e),
                      It.push(_);
                  }
                  It.hide();
                }
              ...
              (function () {
                  ...
                  i.options.add(new Option(t, '-1')),
                    ...
                    (i.onchange = function (t) {
                      ...
                      'back' == this.value && Ie(),
                        'out' == this.value && te(),
                        'in' == this.value && $t(),
                        'left' == this.value && ee('-.25', 'x'),
                        'right' == this.value && ee('.25', 'x'),
                        'up' == this.value && ee('-.25', 'y'),
                        'down' == this.value && ee('.25', 'y'),
                        setTimeout(function () {
                          i.value = '-1';
                        }, 1e3);
                    });
                ...
                var n = void 0 === _.states_title ? 'States' : _.states_title,
                  ...
                  s = {
                    state: { title: n, array: fe },
                    location: { title: r, array: ze },
                    region: { title: a, array: ve },
                  };
                for (var l in s) {
                  var c = s[l],
                    m = e.indexOf(l) > -1,
              ...
              (function () {
                if (
                  !(!i.legend || !i.legend.entries || i.legend.entries.length < 1 || (nt && it))
                ) {
                  var t = {};
                  (gt.style.left = '0em'),
                    (gt.style.bottom = '0em'),
                    (gt.style.padding = '.8em'),
                    (gt.style['background-color'] = nt ? '#ffffff' : 'rgba(186, 186, 186, 0.2)');
                  ...
                  for (r = 0; r < l.length; r++)
                    o.addEvent(l[r], 'mouseover', c), o.addEvent(l[r], 'mousedown', c);
                }
                function c() {
                  for (var e = this.dataset.id, o = t[e], i = 0; i < o.length; i++) {
                    var n = o[i].sm;
                    ('state' == n.type ? Ae : ui)(n.id);
                  }
                }
                function m(e, o) {
                  t[e] = [];
                  ...
                  for (var n in i) {
                    ...
                    o.ids
                      ...
                      : a.sm.attributes.fill != o.color || a.sm.hide || t[e].push(a);
                  }
                }
              })(),
              Co(),
    ...
    function mi(e, o, i) {
      ...
      return p || d
        ...
        ? ri(n.sm.region, function () {
            mi(e, o, i);
          })
        : ((k = !0),
          a ? Te.call(n) : Se.call(n),
          je.reset_pos(m, u, n),
          (h = !0),
          (k = !1),
          i(),
