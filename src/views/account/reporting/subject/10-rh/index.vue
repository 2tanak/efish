        ...
        <div class="col-xl-10 col-lg-9">
          <div class="content-wrapper">
            <div class="card__content">
              <HeaderBack
                :title="'Сведения о контрольно-инспекционной деятельности территориальных органов в части охраны рыбных ресурсов'"
              />
                ...
                <div class="table__block--content">
                  ...
                  >
                    ...
                    <template v-slot:item.action="{ item }">
                      <router-link
                        :to="
                          '/' + $i18n.locale + '/account/reporting/' + 10 + '-rh' + `/${item.id}`
                        "
                      >
                        <svg
                          width="18"
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: 'Наименование отчета', value: 'name', width: '20vw' },
        { text: 'Дата создания', value: 'date_of_submission', width: '10vw' },
        { text: 'Статус', value: 'status', width: '10vw' },
        {
  ...
  methods: {
    ...
    apiGetReportingList(page, per_page) {
      api
        .get('subject/list/10', { params: { page, per_page } })
        .then((response) => {
          if (response.data) {
