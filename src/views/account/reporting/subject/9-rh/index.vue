                ...
                <div class="table__block--content">
                  <div class="table__block--filter">
                    ...
                    <div class="table__filter--right">
                      <router-link
                        v-if="$store.getters.userPermission(['change_reporting-9rh'])"
                        :to="'/' + $i18n.locale + '/account/reporting/' + 9 + '-rh' + '/create'"
                  ...
                  >
                    ...
                    <template v-slot:item.action="{ item }">
                      <router-link
                        :to="'/' + $i18n.locale + '/account/reporting/' + 9 + '-rh' + `/${item.id}`"
                      >
                        <svg
                          width="18"
                          height="18"
...
export default {
  ...
  methods: {
    ...
    apiGetReportingList(page, per_page) {
      api
        .get('subject/list/9', { params: { page, per_page } })
        .then((response) => {
          if (response.data) {
