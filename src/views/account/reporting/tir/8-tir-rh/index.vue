        ...
        <div class="col-xl-10 col-lg-9">
          <div class="content-wrapper">
            <div class="card__content">
              <HeaderBack :title="'ОТПРАВЛЕННЫЕ ОТЧЕТЫ 8_PX'" />
              <div class="card__content--body index-page">
                <div class="table__block--content">
                  <div class="table__block--filter">
                    <div class="table__filter--right">
                      <router-link
                        :to="'/' + $i18n.locale + '/account/reporting/8-tir-rh/list/8'"
                      ...
                      <router-link
                        v-if="$store.getters.userPermission(['change_reporting-8rh'])"
