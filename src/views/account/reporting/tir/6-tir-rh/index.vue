                ...
                <div class="table__block--content">
                  <div class="table__block--filter">
                    ...
                    <div class="table__filter--right">
                      <router-link
                        ...
                        :to="'/' + $i18n.locale + '/account/reporting/' + '6-tir-rh' + '/create'"
                  ...
                  >
                    ...
                    <template v-slot:item.action="{ item }">
                      <router-link
                        :to="
                          '/' + $i18n.locale + '/account/reporting/' + 6 + '-tir-rh' + `/${item.id}`
                        "
                      >
                        <svg
                          width="18"
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: this.$t('headers.created_at'), value: 'date_of_submission' },
  ...
  methods: {
    ...
    apiGetReportingList(page, per_page) {
      api
        .get('tir/list/6', { params: { page, per_page } })
        .then((response) => {
          if (response.data) {
