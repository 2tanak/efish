        ...
        <div class="col-xl-10 col-lg-9">
          <div class="content-wrapper">
            <div class="card__content">
              <HeaderBack :title="'ОТПРАВЛЕННЫЕ ОТЧЕТЫ 7_PX'" />
              <div class="card__content--body index-page">
                <div class="table__block--content">
                  <div class="table__block--filter">
                    <div class="table__filter--right">
                      <router-link
                        :to="'/' + $i18n.locale + '/account/reporting/7-tir-rh/list/7'"
                      ...
                      <router-link
                        v-if="$store.getters.userPermission(['change_reporting-7rh'])"
