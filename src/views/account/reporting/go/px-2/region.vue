        ...
        <div class="col-xl-10 col-lg-9">
          <div class="content-wrapper">
            <div class="card__content">
              <HeaderBack
                :title="'Сведения о деятельности егерских служб пользователей животного мира, осуществляющих охрану рыбохозяйственных водоемов и (или) участков(По регионам)'"
              />
  ...
  data() {
    return {
      ...
      headers: [
        ...
        {
          text: 'Количество егерей (человек) (На начало отчетного периода)',
          value: 'count_of_gamekeeper_start_of_reporting_period',
          width: 200,
          sortable: false,
        },
        {
          text: 'Количество егерей (человек) (На начало года)',
          value: 'count_of_gamekeeper_start_of_year',
          width: 200,
          sortable: false,
        },
        {
          text: 'Количество протоколов (актов) составленных егерями за нарушение природоохранного законодательства за отчетный период',
          value: 'count_of_protocols',
          width: 350,
          sortable: false,
        },
      ],
...
.px-2.v-data-table__wrapper th span {
