  ...
  data() {
    return {
      ...
      headers: [
        ...
        // { text: 'Лимит (тонн)', value: 'sum_actually_grown_by_species_weight', sortable: false },
        // { text: 'Лимит (тонн)', value: 'sum_crustaceans_count', sortable: false },
        // { text: 'Лимит (тонн)', value: 'sum_cultivation_workers_count', sortable: false },
        // { text: 'Лимит (тонн)', value: 'sum_electricity_cost', sortable: false },
        // { text: 'Лимит (тонн)', value: 'sum_enclosed_area', sortable: false },
        // { text: 'Лимит (тонн)', value: 'sum_exported_fish_cost', sortable: false },
        // { text: 'Лимит (тонн)', value: 'sum_exported_fish_volume', sortable: false },
        // { text: 'Лимит (тонн)', value: 'sum_feed_cost', sortable: false },
        // { text: 'Лимит (тонн)', value: 'sum_fish_material_cost', sortable: false },
        // { text: 'Лимит (тонн)', value: 'sum_fish_processing_workers_count', sortable: false },
        // { text: 'Лимит (тонн)', value: 'sum_fry_count', sortable: false },
        // { text: 'Лимит (тонн)', value: 'sum_investment_cost', sortable: false },
        // { text: 'Лимит (тонн)', value: 'sum_larvae_count', sortable: false },
        // { text: 'Лимит (тонн)', value: 'sum_mineral_fertilizers_cost', sortable: false },
        // { text: 'Лимит (тонн)', value: 'sum_primary_activity', sortable: false },
        // { text: 'Лимит (тонн)', value: 'sum_purchase_of_broodstock_cost', sortable: false },
        // { text: 'Лимит (тонн)', value: 'sum_purchase_of_medicines_cost', sortable: false },
        // { text: 'Лимит (тонн)', value: 'sum_rbo_development_cost', sortable: false },
        // { text: 'Лимит (тонн)', value: 'sum_repair_material_cost', sortable: false },
        // { text: 'Лимит (тонн)', value: 'sum_repair_material_count', sortable: false },
        // { text: 'Лимит (тонн)', value: 'sum_yearlings_count', sortable: false },
        {
        ...
        {
          text: 'План выращивания по видам, тонн',
          value: 'sum_growing_plan_by_species',
          sortable: false,
        },
        {
          text: 'Фактически выращено по видам тонн / тыс. тенге',
          value: 'sum_actually_grown_by_species_cost',
          sortable: false,
        },
        {
          text: 'Производственная мощность (тонн в год)',
