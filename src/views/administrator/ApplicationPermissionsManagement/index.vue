                ...
                <div class="table__block--content">
                  <div class="table__block--filter">
                    ...
                    <div class="table__filter--right">
                      <router-link
                        v-if="$store.getters.userPermission(['change_permission_catch'])"
                        :to="'/' + $i18n.locale + '/account/application-permissions/create'"
                  ...
                  >
                    ...
                    <template v-slot:item.action="{ item }">
                      <router-link
                        :to="'/' + $i18n.locale + '/account/application-permissions/' + item.id"
...
export default {
  ...
  methods: {
    apiGetUserQuotasList() {
      api
        .get('application-permission/list')
        .then((response) => {
          if (response.data) {
