                ...
                <div class="table__block--content">
                  <div class="table__block--filter">
                    ...
                    <div class="table__filter--right">
                      <router-link
                        ...
                        :to="'/' + $i18n.locale + '/account/references/create'"
                        class="btn--link btn--link--plus"
                      >
                        Создать справочник <img src="../../../assets/img/icon-plus.svg" />
                      </router-link>
                    </div>
                  </div>
                  ...
                  >
                    <template v-slot:item.name="{ item }">
                      <router-link
                        :to="'/' + $i18n.locale + '/account/references/' + item.id"
                    ...
                    <template v-slot:item.action="{ item }">
                      <router-link
                        v-if="$store.getters.userPermission(['change_catalog'])"
                        :to="'/' + $i18n.locale + '/account/references/' + item.id + '/list'"
                        class="tb__table--btn tb__table--list"
                        v-tooltip.top-center="{ content: 'Справочник', class: ['tooltip__btn'] }"
                      >
                        <svg
                          width="18"
                          height="18"
                      ...
                      <router-link
                        v-if="$store.getters.userPermission(['change_catalog'])"
                        :to="'/' + $i18n.locale + '/account/references/' + item.id + '/edit'"
...
export default {
  ...
  data() {
    return {
      ...
      Categories: 'all',
      filterCategories: this.$t('orders_status.userList'),
      orderList: this.$t('orders_status.user'),
