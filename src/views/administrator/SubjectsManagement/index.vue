    ...
    <div class="container" v-if="$store.state.userObject">
      <div class="row">
        <div class="col-xl-2 col-lg-3">
          <v-sidebar :active="['SubjectsManagement']"></v-sidebar>
        </div>
                ...
                <div class="table__block--content">
                  ...
                  >
                    ...
                    <template v-slot:item.action="{ item }">
                      <router-link
                        v-if="$store.getters.userPermission(['read_subject_all'])"
                        :to="'/' + $i18n.locale + '/account/subjects-list/' + item.id + '/list'"
