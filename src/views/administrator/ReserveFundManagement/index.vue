    ...
    <div class="container" v-if="applications">
      <div class="row">
        <div class="col-xl-2 col-lg-3">
          <v-sidebar :active="['ReserveFundManagement']"></v-sidebar>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        { text: 'Id', value: 'id' },
        { text: 'Наименование водоема', value: 'name', width: '60%' },
        { text: 'Остаток от квоты', value: 'found', align: 'center' },
