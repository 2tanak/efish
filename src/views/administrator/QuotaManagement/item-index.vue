                ...
                <div class="table__block--content">
                  <div class="table__block--filter">
                    ...
                    <div class="table__filter--right">
                      <router-link
                        v-if="
                          $store.getters.userPermission(['change_quota']) &&
                      ...
                      >
                        Заявка на водоем <img src="../../../assets/img/icon-plus.svg" />
                      </router-link>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <template v-slot:item.status="{ item }">
                      ...
                      >
                        ...
                        {{ item.status == 'sent_manager' ? 'Отправлен руководителю' : '' }}
...
export default {
  ...
  methods: {
    apiGetLimitList() {
      api
        .get('quota/' + this.$route.params.id + '/list', {
          headers: {
