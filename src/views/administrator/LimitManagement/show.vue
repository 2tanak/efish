              ...
              <div class="card__content-header">
                <div class="content__title">
                  ...
                  <div class="content__title--element">
                    <div class="content__title--text">Редактирование лимита</div>
                    ...
                    <div class="form__line--right">
                      <div class="col-xl-5">
                        <div class="form__line--input" :class="[errorMessage.messages && errorMessage.messages.name ? 'input--error' : '']">
                          <input type="text" class="input-linck" required="" name="name" v-model="applications.name"  placeholder="Наименование">
                        </div>
                        ...
                        <div class="modal__form">
                          <div class="form__line">
                            <div class="form__line--right">
                              ...
                              >
                                <p v-for="massage in errorMessage.messages.link">{{ massage }}</p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="block__row">
                            <div class="block__row--left">
                              ...
                              >
                                ...
                                >
                                  <path
                                    d="M10.0001 18.3333C14.6024 18.3333 18.3334 14.6023 18.3334 9.99996C18.3334 5.39758 14.6024 1.66663 10.0001 1.66663C5.3977 1.66663 1.66675 5.39758 1.66675 9.99996C1.66675 14.6023 5.3977 18.3333 10.0001 18.3333Z"
                                    stroke="#F19797"
                                    stroke-width="1.5"
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
