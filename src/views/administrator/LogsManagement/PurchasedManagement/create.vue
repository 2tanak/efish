                        ...
                        <div class="form__line--right">
                          <div class="row">
                            <div class="col-xl-5">
                              ...
                              >
                                <p v-for="massage in errorMessage.messages.company">
                                  {{ massage }}
                                </p>
                              </div>
                            </div>
                            ...
                            <div class="col-xl-5">
                              ...
                              >
                                <input
                                  ...
                                  v-model="value.certificate_sender"
                                  value=""
                                  placeholder="Номер"
                                />
                              </div>
                            ...
                            <div class="col-xl-5">
                              <div
                                ...
                                :class="[
                                  ...
                                  errorMessage.messages.certificate_interior
                                    ? 'input--error'
                                    : '',
                                ]"
                              >
                                <input
                                  ...
                                  v-model="value.certificate_interior"
                                  value=""
                                  placeholder="Номер"
                                />
                              </div>
                                          ...
                                          <div class="form__line--input">
                                            ...
                                            >
                                              <template
                                                slot="singleLabel"
                                                slot-scope="{ option }"
                                                >{{ option.values[0].value }}</template
                                              >
  ...
  methods: {
    ...
    validateFirm() {
      ...
      if (this.data.type == 'interior') {
        ...
        if (this.$refs.company.value == '') {
          valid = true;
          messages.company = [this.$t('system_message.required_message')];
        }
      }
      if (this.data.type == 'import') {
        ...
        if (this.$refs.country_id.value == '') {
          valid = true;
          messages.country_id = [this.$t('system_message.required_message')];
        }
        if (this.$refs.certificate_sender.value == '') {
          valid = true;
          messages.certificate_sender = [this.$t('system_message.required_message')];
        }
        if (this.$refs.certificate_interior.value == '') {
          valid = true;
          messages.certificate_interior = [this.$t('system_message.required_message')];
        }
      }
    ...
    onSubmit() {
      ...
      if (this.data.type == 'import') {
        ...
        formData.append('certificate_sender', this.$refs.certificate_sender.value);
        formData.append('certificate_interior', this.$refs.certificate_interior.value);
      }
      ...
      api
        .post('purchased/create', formData)
        .then((response) => {
          if (response.status == 200) {
            this.message.status = 200;
            this.message.text = response.data.message;
            this.$router.push({
              path: '/' + this.$i18n.locale + '/account/logs/purchased/' + response.data.data.id,
            });
          }
        })
        .catch((error) => {
