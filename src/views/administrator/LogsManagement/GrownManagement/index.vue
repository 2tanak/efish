              ...
              <div class="card__content-header">
                <div class="content__title">
                  <div class="content__title--element">
                    <div class="content__title--text">Журналы выращенной рыбы</div>
                  </div>
                </div>
              </div>
                ...
                <div class="table__block--content">
                  <div class="table__block--filter">
                    ...
                    <div class="table__filter--right">
                      <router-link
                        ...
                        :to="'/' + $i18n.locale + '/account/logs/grown/create'"
                  ...
                  >
                    <template v-slot:item.name="{ item }">
                      <router-link :to="'/' + $i18n.locale + '/account/grown/' + item.id">
                    ...
                    <template v-slot:item.action="{ item }">
                      <router-link
                        :to="'/' + $i18n.locale + '/account/logs/grown/' + item.id"
...
export default {
  ...
  methods: {
    ...
    apiGetUserTradeList(page = 1, per_page = 10) {
      api
        .get(
          `grown/list?user_id=${this.$store.state.userObject.id}&page=${page}&per_page=${per_page}`,
        )
        .then((response) => {
          if (response.data) {
