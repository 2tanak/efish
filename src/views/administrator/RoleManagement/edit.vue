<template>
  <div
    class="wrap__content"
    v-bind:class="{ 'wrap__content--preloader': !permissionsList || !applications }"
  >
    <v-preloader v-if="!permissionsList || !applications" :message="errorMessage"></v-preloader>

    <div class="container" v-if="permissionsList && applications">
      <div class="row">
              ...
              <div class="card__content-header">
                <div class="content__title">
                  ...
                  <div class="content__title--element">
                    <div class="content__title--text">Редактирование роли</div>
                        ...
                        <div class="col-xl-5">
                          ...
                          >
                            <textarea
                              ...
                              required=""
                              name="description"
                              v-model="applications.description"
...
export default {
  ...
  methods: {
    ...
    onSubmit(evt) {
      ...
      api
        .post('user/role/' + this.$route.params.id, formData, {
          headers: {
            'Content-Type': 'multipart/form-data',
          },
        })
      ...
      api
        ...
        .then((response) => {
          if (response.data) {
            ...
            this.permissionsSelect = this.applications.accesses;
            this.permissions = this.permissionsList.filter((element) => {
              return this.permissionsSelect.includes(element.value);
            });
          }
        })
        .catch((error) => {
