                        ...
                        >
                          ...
                          >
                            <template slot="option" slot-scope="{ option }">{{
                              option.created_at | formatOnlyYear
                            }}</template>
                  ...
                  <div class="table__block--content">
                    <v-data-table
                      ...
                      :headers="[
                        ...
                        { text: 'Водоем', value: 'pond', sortable: false },
                        {
                          text: 'Егерей(На начало года)',
                          value: 'rangers_beginning_year',
                          sortable: false,
                        },
                        {
                          text: 'Егерей(На начало отчетного периода)',
                          value: 'rangers_beginning_reporting',
                          sortable: false,
                        },
                        { text: 'Количество протоколов', value: 'protocols', sortable: false },
                      ]"
                      :items="[
                        {
                          user_id: '8',
                          pond: 'Камыстыбасская система озер',
                          user_name: 'ТОО Рыбка',
                          rangers_beginning_year: 2,
                          rangers_beginning_reporting: 2,
                          protocols: 1,
                        },
                        {
                          user_id: '8',
                          pond: 'Камыстыбасская система озер',
                          user_name: 'ТОО Баубек',
                          rangers_beginning_year: 2,
                          rangers_beginning_reporting: 2,
                          protocols: 1,
                        },
