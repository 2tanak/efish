        ...
        <div class="col-xl-10 col-lg-9">
          <div class="content-wrapper">
            <div class="card__content">
              <HeaderBack :title="'ОТПРАВЛЕННЫЕ ОТЧЕТЫ 2_PX'" />
              <div class="card__content--body index-page">
                <div class="table__block--content">
                  <div class="table__block--filter">
                    <div class="table__filter--right">
                      <router-link
                        :to="'/' + $i18n.locale + '/account/reporting/2-tir-rh/archive/2'"
                  ...
                  >
                    ...
                    <template v-slot:item.action="{ item }">
                      ...
                      <a class="tb__table--btn tb__table--list"
                         :href="'https://api.efish.airweb.kz/api/v1/ubject/pdf/1?id='+item.id" target="_blank" download
