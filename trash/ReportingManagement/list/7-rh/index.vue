                ...
                <div class="table__block--content">
                  <div class="table__block--filter">
                    ...
                    <div class="table__filter--right">
                      <router-link
                        ...
                        :to="'/' + $i18n.locale + '/account/reporting/' + '7-rh' + '/create'"
                  ...
                  >
                    ...
                    <template v-slot:item.action="{ item }">
                      <router-link
                        :to="'/' + $i18n.locale + '/account/reporting/' + 7 + '-rh' + `/${item.id}`"
                      >
                        <svg
                          width="18"
                          height="18"
                      ...
                      <router-link
                        ...
                        :to="'https://api.efish.airweb.kz/api/v1/subject/pdf/7?id=' + item.id"
                        target="_blank"
                        download
