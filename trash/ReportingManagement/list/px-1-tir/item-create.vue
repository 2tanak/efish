                  ...
                  <div class="table__block--content">
                    <v-data-table
                      ...
                      :headers="[
                        ...
                        { text: 'Лимит (тонн)', value: 'limit_plan', sortable: false },
                        { text: 'Фактич (тонн)', value: 'limit_fact', sortable: false },
                        {
                          text: 'Платежи план (тысяч тенге)',
                          value: 'payments_plan',
                          sortable: false,
                        },
                        {
                          text: 'Платежи факт (тысяч тенге)',
                          value: 'payments_fact',
                          sortable: false,
                        },
                      ]"
