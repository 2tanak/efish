        ...
        <div class="col-xl-10 col-lg-9">
          <div class="content-wrapper">
            <div class="card__content">
              <HeaderBack
                :title="'Сведения об освоении квоты вылова рыбы и других водных животных пользователями'"
              />
              <div class="card__content--body">
                <div class="table__block--content">
                  <div class="table__block--filter">
                    ...
                    <div class="table__filter--right">
                      <router-link
                        ...
                        :to="'/' + $i18n.locale + '/account/reporting/' + 1 + '-rh' + '/create'"
                  ...
                  >
                    ...
                    <!-----
                    <template v-slot:item.date_of_submission="{ item }">
						
                    </template>
					--------->
                    <template v-slot:item.stataus="{ item }">
                      <a class="tb__table--link">
                    ...
                    <template v-slot:item.action="{ item }">
                      <router-link
                        :to="
                          '/' + $i18n.locale + '/account/reporting/' + 1 + '-rh' + `/${item.id}`
                        "
                      >
                        <!-----
                      <a v-if="item.status === 'Создан'"
                        :href="
                          '/' +
                          $i18n.locale +
                          '/account/reporting/' +
  ...
  data() {
    return {
      ...
      headers: [
        ...
        {
          text: 'Дата сдачи отчета',
          value: 'date_of_submission',
          width: '10vw',
        },
        { text: 'Период сдачи', value: 'surender_dates', width: '10vw' },
        //{ text: "Срок представления", value: "", width: "10vw" },
