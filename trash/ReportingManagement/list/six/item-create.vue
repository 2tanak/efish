              ...
              <div class="card__content--body">
                <form method="POST">
                  ...
                  <div>
                    ...
                    <div class="form__line--title">Жайык-Каспийский бассейн</div>

                    <hr />

                    <div class="form__line">
                      <div class="form__line--left">
                        <div class="form__line--title">Река Жайык</div>
                      </div>
                      <div class="form__line--right">
                        <div class="row">
                          <div class="col-xl-6">
                          ...
                          <div class="col-xl-12">
                            <div class="form__line--title">
                              <center>
                                Закрепление рыбохозяйственных водоемов за рыбохозяйственными
                                организациями
                              </center>
                              <br />
                            </div>
                            <div class="row">
                              ...
                              <div class="col-xl-4">
                                <div class="form__line--title">% закрепления <br /><br /></div>
                                <div class="form__line--input">
                                  <input
                                    type="text"
                                    required="required"
                          ...
                          <div class="col-xl-12">
                            <div class="form__line--title">
                              Количество незакрепленных рыбохозяйственных водоемов (с указанием
                    ...
                    <div class="form__line">
                      <div class="form__line--left">
                        <div class="form__line--title">Река Кигаш</div>
                      </div>
                      <div class="form__line--right">
                        <div class="row">
                          <div class="col-xl-6">
                    ...
                    <div class="form__line">
                      <div class="form__line--left">
                        <div class="form__line--title">Каспийское море</div>
                      </div>
                      <div class="form__line--right">
                        <div class="row">
                          <div class="col-xl-6">
