              ...
              <div class="card__content--body">
                <div class="table__block--content">
                  <div class="table__block--filter">
                    ...
                    <div class="table__filter--right">
                      <router-link
                        ...
                        :to="'/' + $i18n.locale + '/account/reporting/' + '6-rh' + '/create'"
                  ...
                  >
                    ...
                    <!--                      <a :href=" urlApi + '/generate/report?id=' + item.id" class="tb__table&#45;&#45;btn tb__table&#45;&#45;list" v-tooltip.top-center="{content:'Скачать', class: ['tooltip__btn']}">-->
