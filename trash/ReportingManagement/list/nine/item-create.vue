              ...
              <div class="card__content--body">
                <form method="POST">
                    ...
                    <div class="form__line">
                      ...
                      <div class="form__line--right">
                        <div class="row">
                          <div class="col-xl-12">
                            <div class="form__line--title">
                              <center>Производственная мощность предприятия</center>
                              <br />
                            </div>
                            <div class="row">
                              <div class="col-xl-6">
                                <div class="form__line--title">Тонн в сутки</div>
                              ...
                              <div class="col-xl-6">
                                <div class="form__line--title">Тонн в год</div>
                                <div class="form__line--input">
                                  <input
                                    type="text"
                                    required="required"
                          ...
                          <div class="col-xl-6">
                            <div class="form__line--title">Сырье для переработки (тонн)</div>
                            <div class="form__line--input">
                              <input
                                type="text"
                                required="required"
                          ...
                          <div class="col-xl-6">
                            <div class="form__line--title">
                              Коэффициент перерасчета выхода готовой продукции
                            </div>
                            <div class="form__line--input">
                              <input
                                type="text"
                          ...
                          <div class="col-xl-12">
                            <div class="form__line--title">
                              Объем конечной переработанной рыбной продукции для реализации (тонн)
                            </div>
                            <div class="form__line--input">
                              <input
                                type="text"
                          ...
                          <div class="col-xl-12">
                            <div class="form__line--title">
                              <center>Источники сырья (тонн)</center>
                              <br />
                            </div>
                            <div class="row">
                              <div class="col-xl-3">
                                <div class="form__line--title">Собственный вылов</div>
                                <div class="form__line--input">
                                  <input
                                    type="text"
                                    required="required"
                              ...
                              <div class="col-xl-3">
                                <div class="form__line--title">Приобретено</div>
                                <div class="form__line--input">
                                  <input
                                    type="text"
                                    required="required"
                              ...
                              <div class="col-xl-3">
                                <div class="form__line--title">Океаническая рыба</div>
                                <div class="form__line--input">
                                  <input
                                    type="text"
                                    required="required"
                              ...
                              <div class="col-xl-3">
                                <div class="form__line--title">Выращенная рыба</div>
                                <div class="form__line--input">
                                  <input
                                    type="text"
                                    required="required"
                          ...
                          <div class="col-xl-6">
                            <div class="form__line--title">
                              Регионы сбыта в Республике Казахстан
                            </div>
                            <div class="form__line--input">
                              <input
                                type="text"
                          ...
                          <div class="col-xl-6">
                            <div class="form__line--title">Экспорт (страна)</div>
                            <div class="form__line--input">
                              <input
                                type="text"
                                required="required"
                          ...
                          <div class="col-xl-12">
                            <div class="form__line--title">
                              Среднегодовая численность работников занятых на переработке рыбной
                              продукции (человек)
                            </div>
                            <div class="form__line--input">
                              <input
                  ...
                  <div class="form__line">
                    <div class="form__line--left">
                      <div class="form__line--title">
                        Фамилия, имя, отчество (при его наличии) руководителя или исполняющее его
                        обязанности областной территориальной инспекции лесного хозяйства и
                        животного мира
                      </div>
                    </div>
                    <div class="form__line--right">
                  ...
                  <div class="form__line">
                    <div class="form__line--left">
                      <div class="form__line--title">
                        Фамилия, имя, отчество (при его наличии) главного бухгалтера, контактный
  ...
  data() {
    return {
      ...
      appList: [
        ...
        'вяленая рыба',
        'копченая рыба',
        'консервы рыбные (туб/тонн)',
        'пресервы рыбные (туб/тонн)',
        'фарш, субпродукты и другие (ракообразные, моллюски)',
