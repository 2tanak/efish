                ...
                <div class="content__title">
                  <div class="content__title--element">
                    <div class="content__title--text">
                      Сведения о деятельности егерских служб пользователей животного мира, осуществляющих охрану рыбохозяйственных водоемов и (или) участков(По субъектам)
                    </div>
                  </div>
                </div>
              </div>
 ...
 watch:{
  ...
  methods: {
    ...
    apiGetAnalytics() {
      ...
      */
      api
        .get("https://api.efish.airweb.kz/api/v1/go/list/1")
        .then((response) => {
          if (response.data) {
